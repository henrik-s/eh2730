...
\hline
FR-CWO-4 &The WOMS shall be able gather system equipment manuals from the NIS. & & Must & \\
\hline
FR-CWO-5 &The WOMS shall be able to link system equipment manuals to WOs. & & Must & 3.2.3 \\
\hline
FR-CWO-6 &The WOMS shall be able to order a new service in the ERP system. & & Must & \\
\hline
FR-CWO-7 &The WOMS shall be able to parse a service order response from the ERP system. &XXXXXXXXX & Must & \\
\hline
FR-CWO-8 &The WOMS shall be able to set a WO as either accepted or denied. & & Must & \\
\hline
FR-CWO-9 &A user shall be able to set a WO as either accepted or denied. &A user is either a MO, M/E or CC user & Must & \\
\hline
FR-CWO-10& & & & \\
\hline
FR-CWO-11& & & & \\
...
FR-IAO-1 &A user shall be able to view the status of a WO. & & Must & \\ 
\hline
FR-IAO-2 &A user shall be able to view the estimated time to completion on a WO. & & Must & \\ 
\hline
...
\hline
FR-AC-3 &An ACC user shall be able to view what sub-contractor  executed a WO. & & Must & \\
\hline
