...
\begin{table}[!ht]
	...
	\end{tabular}
\end{table}
* The \emph{Manage requirements} phase will continue after the pre-study has past \cite{gott7}.
...
\bibitem{maylor} \emph{Maylor, Harvey. \textsl{"Project Management", forth edition}. Financial Times, 2010}
