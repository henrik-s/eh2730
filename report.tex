...
\begin{table}[!ht]
	...
	\hline
		\textit{Process} & \textit{Phases} & \textit{Input} & \textit{Output} & \textit{Time (h)} & \textit{Completion Date} \\
	\hline
		Pre-Study & Elicitation & Prior work,  & & 750 & 1 Mar\\
...
\begin{table}[H]
	...
	\hline
		...
		Analysis & Process Map & 18& 6 Dec &\\ \cline{2-4}
				 ...
				 \hline
		Specification & Create URD & 90& 1 Feb &\\ \cline{2-4}
				 & Create SRS & 90& 10 Feb &180\\ \cline{2-4}
				 \hline
		Validation & Peer Review& 18& 15 Feb &\\ \cline{2-4}
				 & Iterate & 18& 20 Feb &36\\ \cline{2-4}
				 \hline
		Management & Create CCCP\&CCB & 49& 1 March &\\ \cline{2-4}
