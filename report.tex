...
After all of the categorization of the stakeholders, a profilization of the stakeholder was conducted, see figure \ref{figure:stakeholder_profiles}. This was made to see what kind of involvement level, interest, needs, concerns, constrains and success criteria each of the stakeholder categories have.
...
\begin{table}[!ht]
	...
	\hline
		Pre-Study & Elicitation & Prior work,  & & 750 &\\
				  & Analysis & vision statement& &  &\\
				  & Specification & and the risk& & &\\
				  & Validation & mitigation strategy & & &\\
				  & Management* & & & &\\ \hline
		Request For Proposal & - & & & 100&\\ \hline
		Proposals & - & & & 2&\\ \hline
		Evaluation, &  & & & 140&\\
		negotiation, & - & & & &\\
		contract & & & & &\\
...
\begin{table}[H]
	...
	\hline
		 		  & Facilitated workshop & 64& & &132\\ \cline{2-3}
		Elicitation & Exploratory prototype & 64& & &\\ \cline{2-3}
				  & Interview & 4& & &\\ \cline{2-3} 
				  \hline
		Analysis & Process Map & 18& & &198\\ \cline{2-3}
				 & Context Diagram & 18& & &\\ \cline{2-3}
				 & Business Policies & 18& & &\\ \cline{2-3}
				 & Business Rules & 18& & &\\ \cline{2-3}
				 & Use Cases & 30& & &\\ \cline{2-3}
				 & Data Model & 12& & &\\ \cline{2-3}
				 & One iteration  & 60& & &\\ \cline{2-3}
				 & Prioritization & 24& & &\\ \cline{2-3} 
				 \hline
		Specification & Create URD & 90& & &180\\ \cline{2-3}
				 & Create SRS & 90& & &\\ \cline{2-3}
				 \hline
		Validation & Peer Review& 18& & &36\\ \cline{2-3}
				 & Iterate & 18& & &\\ \cline{2-3}
				 \hline
		Management & Create CCCP\&CCB & 49& & &189\\ \cline{2-3}
				 & Manage changing requirements & 140& & &\\ \cline{2-3} 
		\hline
...
For probably every project, having a risk management strategy is of great importance because the occurrence of changes and unpredictable events lies in project management's nature \cite{källa?}. The primary focus of this project plan is on requirements. In this section, a risk analysis created according to Gottesdiener Requirement Risk Mitigation Strategy \cite{gott37}, is presented. 
...
As a part of the policy to use open standards when possible, the company has specified a couple of document standards. Relevant document standards that will be used, in this project, are the standards for the URD and SRS documents.
