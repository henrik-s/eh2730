...
For probably every project, having a risk management strategy is of great importance because the occurrence of changes and unpredictable events lies in project management's nature \cite{källa?}. The primary focus of this project plan is on requirements. In this section, a risk analysis created according to Gottesdiener Requirement Risk Mitigation Strategy \cite{gott2}, is presented. 
